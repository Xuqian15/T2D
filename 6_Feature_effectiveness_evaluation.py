...
parser.add_argument('--profile','-p',help = 'input file : microbial profile')#Bacteria_boruta_selected_feature.txt
...
parser.add_argument('--cohort','-b',help = 'input param : batch(cohort) column name')#Cohort
parser.add_argument('--classifier','-c',help = 'input param : selected classifier')#RandomForest
parser.add_argument('--seed','-s',help = 'input param : random seed')#730
parser.add_argument('--threshold','-t',help = 'input param : auc threshold')#0.7
parser.add_argument('--output','-o',help = 'output file prefix: feature effectiveness evaluation result')#Bacteria
...
feature_auc.to_csv(args.Workplace+args.output+"_feature_auc2.txt",sep = '\t')
effective_feature.to_csv(args.Workplace+args.output+'_effective_feature2.txt', sep = '\t')
